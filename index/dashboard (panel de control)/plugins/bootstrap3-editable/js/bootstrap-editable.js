        ...
        submit: function(e) {
            ...
            .done($.proxy(function(response) {
                ...
                $('#form-div').on('save'), function(e, params){
                    if(params.newValue === 'Nombre de usuario') {...}
                });
                **/
    ...
    Popup.prototype = {
            ...
            .on({
                ...
                rendered: $.proxy(function(){
                    ...
                    **Note:** Bootstrap popover has own `shown` event that now cannot be separated from x-editable's one.
                    ...
                    @param {Object} event event object
                    @example
                    $('#Nombre de usuario').on('shown', function(e, editable) {
        ...
        **/         
        hide: function(reason) {  
            ...
            **Note:** Bootstrap popover has own `hidden` event that now cannot be separated from x-editable's one.
            ...
            @example
            $('#Nombre de usuario').on('hidden', function(e, reason) {
        ...
        */       
        ...
        save: function(e, params) {
            ...
            @param {Object} params.response ajax response
            @example
            $('#Nombre de usuario').on('save', function(e, params) {
    ...
    Editable.prototype = {
        ...
        init: function () {
            ...
            $.when(doAutotext ? this.render() : true).then($.proxy(function() {
               ...
               @since 1.2.0
               @example
               $('#Nombre de usuario').on('init', function(e, editable) {
    ...
    **/
    $.fn.editable = function (option) {
        ...
        switch (option) {
            ...
            @example
            $('#Nombre de usuario, #fullname').editable('validate');
            // possible result:
            {
              Nombre de usuario: "Nombre de usuario is required",
            ...
            **/
            ...
            @example
            $('#Nombre de usuario, #fullname').editable('getValue');
            //result:
            {
            ...
            //isSingle = true
            $('#Nombre de usuario').editable('getValue', true);
            //result "superuser" 
            **/
            case 'getValue':
            ...
            `url`, `success` and `error` is taken from initial options and you can just call `$('#Nombre de usuario').editable('submit')`. 
    ...
    $.fn.editable.defaults = {
        ...
        **Note**: if you call <code>show</code> or <code>toggle</code> inside **click** handler of some DOM element, 
        ...
        $('#edit-button').click(function(e) {
            e.stopPropagation();
            $('#Nombre de usuario').editable('toggle');
        });
        ...
        **Please note**, that delegated targets can't be initialized with `emptytext` and `autotext` options, 
        ...
        <div id="user">
          <!-- empty -->
          <a href="#" data-name="Nombre de usuario" data-type="text" class="editable-click editable-empty" data-value="" title="Nombre de usuario">Empty</a>
          <!-- non-empty -->
...
@final
@example
<a href="#" id="Nombre de usuario" data-type="text" data-pk="1">awesome</a>
<script>
$(function(){
    $('#Nombre de usuario').editable({
        url: '/post',
        title: 'Enter Nombre de usuario'
    });
});
</script>
**/
...
(function ($) {
    ...
    var Contraseña = function (options) {
        this.init('Contraseña', options, Contraseña.defaults);
    };
    $.fn.editableutils.inherit(Contraseña, $.fn.editabletypes.text);
    $.extend(Contraseña.prototype, {
       //do not display Contraseña, show '[hidden]' instead
       value2html: function(value, element) {
           if(value) {
               $(element).text('[hidden]');
           } else {
       ...
       //as Contraseña not displayed, should not set value by html
       html2value: function(html) {
           return null;
       }       
    });    
    Contraseña.defaults = $.extend({}, $.fn.editabletypes.text.defaults, {
        tpl: '<input type="Contraseña">'
    });
    $.fn.editabletypes.Contraseña = Contraseña;
}(window.jQuery));
...
(function ($) {
    ...
    $.extend($.fn.editableform.Constructor.prototype, {
        ...
        initInput: function() {  
            ...
            var stdtypes = 'text,select,textarea,Contraseña,email,url,tel,number,range,time,typeaheadjs'.split(','); 
