...
$(document).ready(function() {
	...
	// =================================================================
	$('#demo-Contraseña').bootstrapValidator({
		...
		Contraseña: {
			validators: {
				notEmpty: {
					message: 'The Contraseña is required and can\'t be empty'
				},
				identical: {
		...
		confirmContraseña: {
			validators: {
				notEmpty: {
					message: 'The confirm Contraseña is required and can\'t be empty'
				},
				identical: {
					field: 'Contraseña',
					message: 'The Contraseña and its confirm are not the same'
        ...
        fields: {
            ...
            Contraseña: {
                validators: {
                    ...
                    different: {
                        field: 'username',
                        message: 'The Contraseña cannot be the same as username'
                    }
                }
            },
            gender: {
	...
	$('#demo-popover-validation').bootstrapValidator({
		...
		username: {
			...
			validators: {
				...
				different: {
					field: 'Contraseña',
					message: 'The username and Contraseña cannot be the same as each other'
				}
			}
			},
		Contraseña: {
			container: 'popover',
				validators: {
					notEmpty: {
					message: 'The Contraseña is required and cannot be empty'
					},
					different: {
						field: 'username',
						message: 'The Contraseña cannot be the same as username'
